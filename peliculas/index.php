                    ...
                    <div class="card shadow-sm">
                        ...
                        <div class="card-body">
                            ...
                            <div class="d-flex justify-content-between align-items-center">
                                ...
                                <div class="btn-group">
                                    <a href="view.php?id=<?= $peli->getId() ?>" class="btn btn-dark"><i class="fa fa-eye"></i></a>
                                    <?php if($usuariActiu): ?>
                                        <a href="edit.php?id=<?= $peli->getId() ?>" class="btn btn-danger"><i class="fa fa-pencil-square"></i></a>
                                    <?php endif; ?>
                                </div>
                            </div>
                        </div>
