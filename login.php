<?php
/**
 * Pàgina d'inici de sessió. Controla l'accés d'usuaris existents.
 */
session_start();
...
// No permet accedir a la pàgina si ja està connectat.
...
// Missatges d'error/ok de sessió.
$missatge_ok = "";
...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    // Verifica la contrasenya amb hash.
    ...
    // Si és correcte, inicia sessió.
    $_SESSION['usuari'] = $usuari->getEmail();

    // Si pulsar "recordar", crea cookie 30 dies.
    ...
    <div class="card" style="width: 24rem;">
        <div class="card-body">
            ...
            <?php if ($missatge_error): ?>
                <div class="alert alert-danger" role="alert"><?= htmlspecialchars($missatge_error) ?></div>
            <?php endif; ?>
            <?php if ($missatge_ok): ?>
                <div class="alert alert-success" role="alert"><?= htmlspecialchars($missatge_ok) ?></div>
            <?php endif; ?>
