...
<html lang="ca">
  <head>
    ...
    <meta name="description" content="Projecte DWES - Gestió pel·lícules">
    <meta name="author" content="Marcestruch, DWES">
    <title>DWES - Pelis</title>
        ...
        <div class="container">
          <div class="row">
            ...
            <div class="col-sm-4 offset-md-1 py-4">
              <!-- Mostra nom usuari -->
              <h4 class="text-white"><?= isset($nom) ? htmlspecialchars($nom) : 'Guest' ?></h4>
